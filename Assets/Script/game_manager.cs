...
public class game_manager : MonoBehaviour
{
  ...
  public AudioSource sound_eat_plant, sound_bullet, sound_die, sound_lawnMower, sound_start,
                     sound_cherryboom, soundWin, soundMain;
  ...
  public void next()
  {
    if (playerData.loadLevel() == SceneManager.GetActiveScene().buildIndex && playerData.loadLevel() < 4)
    {
      playerData.setLevel();
    }
